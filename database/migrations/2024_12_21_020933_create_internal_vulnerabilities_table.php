...
class CreateInternalVulnerabilitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('internal_vulnerabilities', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('internal_vulnerabilities');
    }
}
