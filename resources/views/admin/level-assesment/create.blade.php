...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.level-assesment.store',['question_assesment'=>$question->id])}}" class="my-4" method="POST" id="form-level-assesment" onsubmit="confirmSave('form-level-assesment', 'Data level akan disimpan')">
                    @csrf
                    <div class="col-xl-12">
                        <div class="form-group mb-3">
                            <label for="level" class="form-label">Level</label>
                            <select class="form-select" id="level" aria-label="Default select example" name="level" required>
