    ...
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        ...
        <div class="text-end">
            <ol class="breadcrumb m-0 py-0">
                ...
                <li class="breadcrumb-item active">Ubah Data Tipe Fasilitas Umum</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.fasum-type.update', $type->id) }}" class="my-4" method="POST"
                        id="form-unit" onsubmit="confirmSave('form-unit', 'Data tipe fasilitas umum akan disimpan')">
                        @csrf
                        @method('PATCH')
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="color" id="color_code" required=""
                                            ...
                                            value="{{ old('color_code', $type->color_code) }}">
