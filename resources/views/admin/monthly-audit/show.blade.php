        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ $backUrl ?? route('admin.monthly-audit.index') }}" class="btn btn-danger"> Back</a>
                </div><!-- end card header -->
                                ...
                                <div class="security mb-3">
                                    ...
                                    <div class="container my-4">
                                        <h5>BULAN : {{ $monthlyReport->report_date }}<h5>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table
                                                                    ...
                                                                    <tbody>
                                                                        @php
                                                                            $total =
                                                                                $employee->employee_man +
                                                                                $employee->employee_woman +
                                                                                $employee->student_man +
                                                                                $employee->student_woman;
                                                                            $totalEmployee =
                                                                                $employee->employee_man +
                                                                                $employee->employee_woman;
                                                                            $totalStudent =
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ number_format($totalEmployee) }} Orang
                                                                            </td>
                                                                            <td>{{ number_format($employee->employee_man) }}
                                                                                Orang</td>
                                                                            <td>{{ number_format($employee->employee_man) }}
                                                                                Orang</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.2 Siswa OJT</td>
                                                                            <td>{{ number_format($totalStudent) }} Orang
                                                                            </td>
                                                                            <td>{{ number_format($employee->student_man) }}
                                                                                Orang</td>
                                                                            <td>{{ number_format($employee->student_woman) }}
                                                                                Orang</td>
                                                                        </tr>
                                                                        <tr class="fw-bold">
                                                        ...
                                                        <table class="table table-bordered text-center align-middle">
                                                            ...
                                                            <tbody class="outsource-table">
                                                                ...
                                                                <tr class="fw-bold sum-outsource">
                                                                    <td>Jumlah</td>
                                                                    <td>{{ number_format($outsources->sum('total')) }}
                                                                        Orang</td>
                                                                    <td>{{ number_format($outsources->sum('man')) }} Orang
                                                                    </td>
                                                                    <td colspan="2">
                                                                        {{ number_format($outsources->sum('woman')) }}
                                                                        Orang</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <table class="table table-bordered text-center align-middle">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>6.5 Lain-lain</td>
                                                                <td>{{ $gangguan->lain_lain ?? 0 }} Kali</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                ...
                                                <div class="fw-bold">
                                                    <p>JUMLAH TOTAL (1+2+3+4): <span>{{ $totalAll }} Orang</span>
                                                        (Pria: <span>{{ $totalAllMan }} Orang</span>)
                                    ...
                                    <table class="table table-bordered text-center align-middle">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-nowrap" colspan="7">Pelatihan Unit
                                                    Pengamanan</th>
                                    ...
                                    <table class="table table-bordered text-center align-middle">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col" rowspan="2">Tindakan Pengamanan Setelah Kejadian
                                                </th>
                                    ...
                                    <table class="table table-bordered text-center align-middle">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-nowrap" rowspan="2">Status Kepemilikan
                                                </th>
                                                <th scope="col" class="text-nowrap" rowspan="2">Satuan</th>
                                                <th scope="col" class="text-nowrap" rowspan="2">Jumlah Standar
                                                    Kontrak</th>
                                            ...
                                            @foreach ($attributes as $attribute)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" disabled
                                                                id="attribute_radioYes{{ $loop->iteration }}"
                                                                {{ $attribute->condition == 1 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="attribute_radioYes{{ $loop->iteration }}">
                                                                Ya
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" disabled
                                                                id="attribute_radiono{{ $loop->iteration }}"
                                                                {{ $attribute->condition == 0 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="attribute_radiono{{ $loop->iteration }}">
                                                                Tidak
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input ms-3" type="radio" disabled
                                                                id="attribute_checkyes{{ $loop->iteration }}"
                                                                {{ $attribute->status_item == 1 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="attribute_checkyes{{ $loop->iteration }}">
                                                                Ya
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input ms-3" type="radio" disabled
                                                                id="attribute_checkno{{ $loop->iteration }}"
                                                                {{ $attribute->status_item == 0 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="attribute_checkno{{ $loop->iteration }}">
                                                                Tidak
                                                            </label>
                                                        </div>
                                                    </td>
                                        ...
                                        <tbody>
                                            @foreach ($administrations as $administration)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="hidden" value="{{ $administration->id }}"
                                                            name="administration[]">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" disabled
                                                                id="administration_radioYes{{ $loop->iteration }}"
                                                                {{ $administration->condition == 1 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="administration_radioYes{{ $loop->iteration }}">
                                                                Ya
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" disabled
                                                                id="administration_radiono{{ $loop->iteration }}"
                                                                {{ $administration->condition == 0 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="administration_radiono{{ $loop->iteration }}">
                                                                Tidak
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input ms-3" type="radio" disabled
                                                                id="administration_checkyes{{ $loop->iteration }}"
                                                                {{ $administration->status_item == 1 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="administration_checkyes{{ $loop->iteration }}">
                                                                Ya
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input ms-3" type="radio" disabled
                                                                id="administration_checkno{{ $loop->iteration }}"
                                                                {{ $administration->status_item == 0 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="administration_checkno{{ $loop->iteration }}">
                                                                Tidak
                                                            </label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if ($administration->attachment_file)
                                                            <a href="{{ asset('uploads/attachment_file_form_attribute/' . $administration->attachment_file) }}"
                                        ...
                                        <tbody>
                                            @foreach ($saranas as $sarana)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="hidden" value="{{ $sarana->id }}"
                                                            name="sarana[]">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" disabled
                                                                id="sarana_radioYes{{ $loop->iteration }}"
                                                                {{ $sarana->condition == 1 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="sarana_radioYes{{ $loop->iteration }}">
                                                                Ya
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" disabled
                                                                id="sarana_radiono{{ $loop->iteration }}"
                                                                {{ $sarana->condition == 0 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="sarana_radiono{{ $loop->iteration }}">
                                                                Tidak
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input ms-3" type="radio" disabled
                                                                id="sarana_checkyes{{ $loop->iteration }}"
                                                                {{ $sarana->status_item == 1 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="sarana_checkyes{{ $loop->iteration }}">
                                                                Ya
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input ms-3" type="radio" disabled
                                                                id="sarana_checkno{{ $loop->iteration }}"
                                                                {{ $sarana->status_item == 0 ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="sarana_checkno{{ $loop->iteration }}">
                                                                Tidak
                                                            </label>
                                                        </div>
                                                    </td>
                            ...
                            <div class="cooperation mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-center align-middle">
                                        <thead class="table-light">
                                            <tr>
                                                <th scope="col" class="text-nowarp align-middle" rowspan="4">No
                                                </th>
                                                <th scope="col" class="text-nowarp align-middle" rowspan="4">Nama
                                                </th>
                                                <th scope="col" class="text-nowarp align-middle" rowspan="4">
                                                    Kebangsaan</th>
                                                <th scope="col" class="text-nowarp align-middle" rowspan="4">
                                                    Perusahaan</th>
                                                <th scope="col" class="text-nowarp align-middle" rowspan="4">
                                                    Jabatan / Keahlian</th>
                                                <th scope="col" class="text-nowarp align-middle" colspan="12">
                                                    Kategori</th>
                                                <th scope="col" class="text-nowarp align-middle" rowspan="3"
                                                    colspan="2">Tanggal</th>
                                                <th scope="col" class="text-nowarp align-middle" rowspan="4">
                                                    Keterangan</th>
                                            </tr>
                                            <tr>
                                                <th scope="col" class="text-nowarp align-middle" colspan="4">Tamu
                                                </th>
                                                <th scope="col" class="text-nowarp align-middle" colspan="8">
                                                    Pekerja</th>
                                            </tr>
                                            <tr>
                                                <th scope="col" class="text-nowarp align-middle" colspan="2">Paspor
                                                </th>
                                                <th scope="col" class="text-nowarp align-middle" colspan="2">Visa
                                                </th>
                                                <th scope="col" class="text-nowarp align-middle" colspan="2">Paspor
                                                </th>
                                                <th scope="col" class="text-nowarp align-middle" colspan="2">Vitas
                                                </th>
                                                <th scope="col" class="text-nowarp align-middle" colspan="2">Kitas
                                                </th>
                                                <th scope="col" class="text-nowarp align-middle" colspan="2">RPTKA
                                                </th>
                                            </tr>
                                            <tr>
                                                    ...
                                                    @if ($foreign->category == 'Tamu')
                                                        ...
                                                        <td>
                                                            @if ($foreign->paspor_file)
                                                                <a href="{{ asset('uploads/attachment_file_foreign_worker/' . $foreign->paspor_file) }}"
                                                                    download=""
                                                        ...
                                                        <td>
                                                            @if ($foreign->visa_file)
                                                                <a href="{{ asset('uploads/attachment_file_foreign_worker/' . $foreign->visa_file) }}"
                                                                    download=""
                                                                    class="btn btn-success btn-sm">download</a>
                                                            @endif
                                                        </td>
                                                    ...
                                                    @if ($foreign->category == 'Pekerja')
                                                        ...
                                                        <td>
                                                            @if ($foreign->vitas_file)
                                                                <a href="{{ asset('uploads/attachment_file_foreign_worker/' . $foreign->vitas_file) }}"
                                                                    download=""
                                                                    class="btn btn-success btn-sm">download</a>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            @if ($foreign->kitas_file)
                                                                <a href="{{ asset('uploads/attachment_file_foreign_worker/' . $foreign->kitas_file) }}"
                                                                    download=""
                                                                    class="btn btn-success btn-sm">download</a>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            @if ($foreign->rptka_file)
                                                                <a href="{{ asset('uploads/attachment_file_foreign_worker/' . $foreign->rptka_file) }}"
                                                                    download=""
                                                                    class="btn btn-success btn-sm">download</a>
                                                            @endif
                                                        </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-primary btn-sm" type="button"
                                                        ...
                                                        data-bs-target="#accordionRow{{ $loop->iteration }}"
                                                        aria-expanded="false" aria-controls="accordionRow1">
                                                        Lihat TimeLine
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr id="accordionRow{{ $loop->iteration }}"
                                                ...
                                                <td colspan="6">
                                                    <table class="table table-bordered text-center">
                                                        <thead class="table-light">
                                                            <tr>
                                                                <th colspan="53">
                                                                    {{ $program->securityProgram->program_name }}</th>
                                                            </tr>
                                                            <tr>
                                                                <th rowspan="2" class="text-center align-middle">No
                                                                </th>
                                                                <th rowspan="2" class="text-center align-middle"
                                                                    colspan="2">Program</th>
                                        ...
                                        <tbody>
                                            @foreach ($administrasi as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ number_format($item->prosentase_penyerapan, 2, ',', '.') }}%
                                                    </td>
