...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.marturity-level.update',['level' =>$level->id,'sub_area'=>$subArea->id])}}" class="my-4" method="POST" id="form-marturity-level" onsubmit="confirmSave('form-marturity-level', 'Data level akan disimpan')">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" name="description">{{old('description',$level->description)}}</textarea>
                            @error('description')
                                <div class="error text-danger">{{ $message }}</div>
                            @enderror
                        </div>
