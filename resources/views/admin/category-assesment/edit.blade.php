...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    ...
    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            ...
            <li class="breadcrumb-item active">Ubah Data Assesment</li>
        </ol>
    </div>
</div>
            ...
            <div class="card-body">
                <form action="{{route('admin.category-assesment.update',['category_assesment'=>$category->id])}}" class="my-4" method="POST" id="form-category-assesment" onsubmit="confirmSave('form-category-assesment', 'Data kategori akan disimpan')">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('name') is-invalid @enderror" name="name" type="text" id="name" required placeholder="Masukan nama" value="{{old('name', $category->name)}}">
                        @error('name')
