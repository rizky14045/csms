...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold m-0">Maturity Note</h4>
    </div>

    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
            <li class="breadcrumb-item active">Ubah Data Maturity Note</li>
        </ol>
    </div>
</div>
<div class="row">
                ...
                <form action="{{route('admin.marturity-note.update',['note'=>$note->id,'level'=>$level->id])}}" class="my-4" method="POST" id="form-marturity-note" onsubmit="confirmSave('form-marturity-note', 'Data note akan disimpan')">
                    ...
                    <div class="col-xl-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('note') is-invalid @enderror" name="note" id="note" rows="6" required placeholder="Masukan note">{{old('note',$note->note)}}</textarea>
                            @error('note')
