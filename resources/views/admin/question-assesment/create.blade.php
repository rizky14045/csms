...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.question-assesment.store',['categoryId'=>$categoryId])}}" class="my-4" method="POST">
                    @csrf
                    <!-- Formulir Pendaftaran -->
                    <div class="col-xl-12">
                        <div class="form-group mb-3">
                            <label for="username" class="form-label">Indikator</label>
                            <input class="form-control" name="indicator" type="text" id="username" required="" placeholder="Masukan indikator" value="{{old('indicator')}}">
