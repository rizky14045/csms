                    ...
                    <div class="accordion-item area-item">
                        ...
                        <h2 class="accordion-header">
                            <div class="d-flex align-items-center w-100 pe-3">
                                ...
                                <div class="btn-action-group ms-3">
                                    ...
                                    <form id="del-area-{{ $area->id }}" action="{{route('admin.marturity-area.destroy',['area'=>$area->id])}}" method="POST" class="m-0">
                                        @csrf @method('DELETE')
                        ...
                        <div id="areaBody{{ $area->id }}" class="accordion-collapse collapse">
                            <div class="accordion-body bg-white pb-3">
                                ...
                                <div class="mb-3">
                                    <a href="{{route('admin.marturity-sub-area.create',['area'=>$area->id])}}" class="btn btn-soft-primary btn-xs px-3 py-2">
                                    ...
                                    <h2 class="accordion-header">
                                        <div class="d-flex align-items-center w-100 pe-3">
                                            ...
                                            <div class="btn-action-group ms-3">
                                                ...
                                                <form id="del-subarea-{{ $subArea->id }}" action="{{route('admin.marturity-sub-area.destroy',['sub_area'=>$subArea->id,'area'=>$area->id])}}" method="POST" class="m-0">
                                                    @csrf @method('DELETE')
                                                    <button type="button" class="btn btn-soft-danger btn-xs"
                                                ...
                                                <h2 class="accordion-header">
                                                    <div class="d-flex align-items-center w-100 pe-3">
                                                        ...
                                                        <div class="btn-action-group ms-3">
                                                            ...
                                                            <form id="del-level-{{ $level->id }}" action="{{route('admin.marturity-level.destroy',['level'=>$level->id,'sub_area'=>$subArea->id])}}" method="POST" class="m-0">
                                                                @csrf @method('DELETE')
                                                                <button type="button" class="btn btn-soft-danger btn-xs"
                                                    ...
                                                    <div class="level-body">
                                                        ...
                                                        <div class="note-item d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div class="btn-action-group">
                                                                ...
                                                                <form id="del-note-{{ $note->id }}" action="{{route('admin.marturity-note.destroy',['note'=>$note->id,'level'=>$level->id])}}" method="POST" class="m-0">
                                                                    @csrf @method('DELETE')
                                                                    <button type="button" class="btn btn-soft-danger btn-xs"
