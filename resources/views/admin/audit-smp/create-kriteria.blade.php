...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.audit-smp.storeKriteria',['auditId'=>$audit->id])}}" class="my-4" method="POST" id="form-audit-smp" onsubmit="confirmSave('form-audit-smp', 'Data element'. {{$audit->name}}. 'akan disimpan')">
                    @csrf
