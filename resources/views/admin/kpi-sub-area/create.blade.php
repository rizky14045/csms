...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    ...
    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            ...
            <li class="breadcrumb-item active">Tambah Data KPI Area</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.kpi-sub-area.store',['area'=>$area->id])}}" class="my-4" method="POST" id="form-kpi-subarea" onsubmit="confirmSave('form-kpi-subarea', 'Data subarea akan disimpan')">
                    @csrf
