...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.kpi-note.store',['level'=>$level->id])}}" class="my-4" method="POST" id="form-kpi-note" onsubmit="confirmSave('form-kpi-note', 'Data note akan disimpan')">
                    @csrf
