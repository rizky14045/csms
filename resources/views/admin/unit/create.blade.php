...
<div class="py-3 d-flex align-items-center gap-2">
    ...
    <h4 class="mb-0">Tambah Data Unit</h4>
</div>
        ...
        <div class="card shadow-sm rounded-4">
            <div class="card-header bg-white border-bottom py-3">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h6 class="mb-0 fw-semibold">Tambah Data Unit</h6>
                </div>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('admin.unit.store') }}" method="POST" id="form-unit"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('name') is-invalid @enderror" type="text" id="name"
                            required placeholder="Masukan nama unit" name="name" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('unit_code') is-invalid @enderror" type="text" id="unit_code"
                            required placeholder="Masukan kode unit" name="unit_code" value="{{ old('unit_code') }}">
                        @error('unit_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="card border mb-3">
                        ...
                        <div class="card-body p-3" id="mapSection">
                            <div class="row mb-3">
                                <div class="col-md-6">
...
@section('scripts')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            const boundsIndonesia = [[-11.0, 95.0], [6.5, 141.0]];

            map = L.map('map', {
                minZoom: 5, maxZoom: 18,
                maxBounds: boundsIndonesia, maxBoundsViscosity: 1.0,
            ...
            document.getElementById('province').addEventListener('change', function () {
                ...
                fetch(routeProvince.replace(':id', id))
                    .then(r => r.json()).then(res => {
                        ...
                        provinceLayer = L.geoJSON(geo, { style: { color: 'blue', weight: 2, fillOpacity: 0.1 } }).addTo(map);
                        map.fitBounds(provinceLayer.getBounds());
                        setTimeout(() => map.setZoom(map.getZoom() + 2.5), 300);
                    });
