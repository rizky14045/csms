...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('user.monthly-audit.security-external.update',['monthlyId'=>$monthlyId,'securityId' =>$security->id])}}" class="my-4" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="col-xl-9">
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan nama" name="name" value="{{$security->name}}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan instansi" name="instansi" value="{{$security->instansi}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan satuan wilayah" name="regional_unit" value="{{$security->regional_unit}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan nomor surat perintah" name="warrant_number" value="{{$security->warrant_number}}">
