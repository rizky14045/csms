                ...
                <form action="{{route('user.monthly-audit.agreement-external.update',['monthlyId'=>$monthlyId,'agreementId'=>$agreement->id])}}" class="my-4" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-xl-9">
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan nama satuan wilayah" name="regional_unit" value="{{$agreement->regional_unit}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan instansi" name="instansi" value="{{$agreement->instansi}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan nama" name="name" value="{{$agreement->name}}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan nomor pkt" name="pkt_number" value="{{$agreement->pkt_number}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan judul pkt" name="pkt_title" value="{{$agreement->pkt_title}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="date" id="emailaddress" required="" name="expired_date" value="{{$agreement->expired_date}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan note" name="note" value="{{$agreement->note}}">
                            @if($errors->has('note'))
