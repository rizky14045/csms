...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('user.monthly-audit.realization-program.update',['monthlyId'=>$monthlyId,'programId'=>$programId,'mainId'=> $main->id])}}" class="my-4" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="col-xl-9">
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" value="{{$main->mainProgram->program_name}}" disabled>
