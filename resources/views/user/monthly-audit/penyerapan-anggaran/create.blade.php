                ...
                <form action="{{route('user.monthly-audit.penyerapan-anggaran.store',['monthlyId'=>$monthlyId])}}" class="my-4" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="number" id="jumlah_anggaran" required="" placeholder="Masukan Jumlah Anggaran" name="jumlah_anggaran" value="{{old('jumlah_anggaran')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="number" id="penyerapan_anggaran" required="" placeholder="Masukan Penyerapan Anggaran" name="penyerapan_anggaran" value="{{old('penyerapan_anggaran')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan keterangan" name="keterangan" value="{{old('keterangan')}}">
