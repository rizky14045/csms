...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    ...
    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            ...
            <li class="breadcrumb-item active">Tambah Data Data AGHT</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('user.monthly-audit.aght.store',['monthlyId'=>$monthlyId])}}" class="my-4" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- Formulir Pendaftaran -->
                    <div class="col-xl-9">
                        <div class="form-group mb-3">
                            <label for="emailaddress" class="form-label">Uraian Kegiatan</label>
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan uraian kegiatan" name="activity" value="{{old('activity')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="date" id="emailaddress" required="" name="incident_date" value="{{old('incident_date')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="time" id="emailaddress" required="" name="incident_time" value="{{old('incident_time')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan tempat kejadian perkara" name="incident_location" value="{{old('incident_location')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan kerugian akibat yang ditimbulkan" name="loss" value="{{old('loss')}}">
                            @if($errors->has('loss'))
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan tindakan pengamanan setelah kejadian" name="after_incident" value="{{old('after_incident')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan aparat yang dihubungi" name="officer_contacted" value="{{old('officer_contacted')}}">
