                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="number" required
                                                                                    ...
                                                                                    value="{{ $employee->employee_man }}"
                                                                                    name="employee_man"> Orang</td>
                                                                            <td><input type="number" required
                                                                                    min="0"
                                                                                    class="form-control w-25 d-inline"
                                                                                    value="{{ $employee->employee_woman }}"
                                                                                    name="employee_woman"> Orang</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>1.2 Siswa OJT</td>
                                                                            ...
                                                                            <td><input type="number" required
                                                                                    min="0"
                                                                                    class="form-control w-25 d-inline"
                                                                                    value="{{ $employee->student_man }}"
                                                                                    name="student_man"> Orang</td>
                                                                            <td><input type="number" required
                                                                                    min="0"
                                                                                    class="form-control w-25 d-inline"
                                                                                    value="{{ $employee->student_woman }}"
                                                                                    name="student_woman"> Orang</td>
                                                                        </tr>
                                                                        <tr class="fw-bold">
                                                ...
                                                <div class="mb-3">
                                                    <div class="d-flex justify-content-between pb-3">
                                                        ...
                                                        <button class="btn btn-success btn-sm" type="button"
                                                            data-bs-toggle="modal" data-bs-target="#outSourceModal">Tambah
                                                            Data</button>
                                                    </div>
                                                    <div class="table-responsive">
                                                        ...
                                                        <button type="submit" class="btn btn-primary float-end">Simpan
                                                            Form</button>
                                                    </div>
                                                </div>
                                            </form>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <table class="table table-bordered text-center align-middle">
                                                    ...
                                                    @php
                                                        ...
                                                        $total = $komandan + $anggota + $chief;
                                                    @endphp
                                                    <tbody>
                                                        <tr>
                                                            <td>3.1 Komandan Regu</td>
                                                            <td>{{ $komandan }} Orang</td>
                                                        </tr>
                                                        <tr>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button type="button" class="btn btn-primary btn-outsource-add"
                        id="btn-outsource-add">Submit</button>
                </div>
            </div>
        </div>
    </div>
