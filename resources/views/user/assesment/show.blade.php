                                    ...
                                    <tbody>
                                        @foreach ($category->questions as $question)
                                            <tr>
                                                ...
                                                <form action="{{ route('user.assesment.updateQuestion', ['question' => $question->id]) }}" method="POST" id="edit-question-{{ $question->id }}" onsubmit="confirmSave('edit-question-{{ $question->id }}', 'Data akan disimpan?')">
                                                    @csrf
                                                    @method('PATCH')
                                                    <td>
