...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('user.security-external.store')}}" class="my-4" method="POST" enctype="multipart/form-data" id="form-security-external" onsubmit="confirmSave('form-security-external', 'Data keamanan eksternal akan disimpan')">
                    @csrf
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="regional_unit" required="" placeholder="Masukan satuan wilayah" name="regional_unit" value="{{old('regional_unit')}}">
                            @error('regional_unit')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="warrant_number" required="" placeholder="Masukan nomor surat perintah" name="warrant_number" value="{{old('warrant_number')}}">
