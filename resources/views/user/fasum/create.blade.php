...
@section('content')
    ...
    <div class="py-3 d-flex align-items-center gap-2">
        ...
        <h4 class="mb-0">Tambah Fasilitas Umum</h4>
    </div>
            ...
            <div class="card shadow-sm rounded-4">
                <div class="card-header bg-white border-bottom py-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h6 class="mb-0 fw-semibold">Tambah Data Fasilitas Umum</h6>
                    </div>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('user.fasum.store') }}" method="POST" id="form-unit"
                        onsubmit="confirmSave('form-unit', 'Data fasilitas umum akan disimpan')">
                        @csrf
                        <div class="col-xl-12">
