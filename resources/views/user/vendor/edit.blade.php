...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('user.vendor.update',['id'=>$vendor->id])}}" class="my-4" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="col-xl-9">
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" id="emailaddress" required="" placeholder="Masukan nama" name="name" value="{{$vendor->name}}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="email" id="emailaddress" required="" placeholder="Masukan email" name="email" value="{{$vendor->email}}">
                            @if($errors->has('email'))
