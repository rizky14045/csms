...
<div class="py-3 d-flex align-items-center gap-2">
    ...
    <h4 class="mb-0">Tambah Penanggung Jawab Keamanan</h4>
</div>
        ...
        <div class="card shadow-sm rounded-4">
            <div class="card-header bg-white border-bottom py-3">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h6 class="mb-0 fw-semibold">Tambah Data Penanggung Jawab Keamanan</h6>
                </div>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('user.responsible-person.store') }}" method="POST" id="form-responsible"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('position') is-invalid @enderror" type="text" id="position"
                            required placeholder="Masukan jabatan" name="position" value="{{ old('position') }}">
                        @error('position')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('work_unit') is-invalid @enderror" type="text" id="work_unit"
                            required placeholder="Masukan unit kerja" name="work_unit" value="{{ old('work_unit') }}">
                        @error('work_unit')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('last_education') is-invalid @enderror" type="text" id="last_education"
                            placeholder="Masukan pendidikan terakhir" name="last_education" value="{{ old('last_education') }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control @error('note') is-invalid @enderror" type="text" id="note"
                            placeholder="Masukan keterangan" name="note" value="{{ old('note') }}">
                        @error('note')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-text text-muted">Jika dicentang, data juga akan disimpan ke daftar master data penanggung jawab.</div>
                    </div>
                    @endif
