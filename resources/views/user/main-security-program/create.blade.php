...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('user.main-security-program.store',['program'=>$programId])}}" class="my-4" method="POST" id="form-program" onsubmit="confirmSave('form-program', 'Data program keamanan akan disimpan')">
                    @csrf
