...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('user.security.store')}}" class="my-4" method="POST">
                    @csrf
                    <!-- Formulir Pendaftaran -->
                    <div class="col-xl-9">
                        <div class="form-group mb-3">
                            <label for="name" class="form-label">Nama</label>
                            <input class="form-control" type="text" required="" id="name" placeholder="Masukan nama" name="name" value="{{old('name')}}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" required="" placeholder="Masukan unit kerja" name="unit_work" value="{{old('unit_work')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" required="" placeholder="Masukan nid" name="nid" value="{{old('nid')}}">
                            @if($errors->has('nid'))
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" required="" placeholder="Masukan nomor reg kta" name="registration_number" value="{{old('registration_number')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="date" required="" name="expired_card_date" value="{{old('expired_card_date')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" required="" placeholder="Masukan tempat lahir" name="birth_place" value="{{old('birth_place')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="date" required="" name="birth_date" value="{{old('birth_date')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" required="" placeholder="Masukan pendidikan terakhir" name="last_education" value="{{old('last_education')}}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="text" placeholder="Masukan note" name="note" value="{{old('note')}}">
                            @if($errors->has('note'))
