...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    ...
    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            ...
            <li class="breadcrumb-item active">Edit Data Audit</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.audit-smp-score.update', $audit->id)}}" class="my-4" method="POST" id="form-audit" onsubmit="confirmSave('form-audit', 'Data audit akan disimpan')">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="date" id="start_audit" required="" placeholder="Masukan tanggal mulai audit" name="start_audit" value="{{old('start_audit', $audit->start_audit)}}">
                            @error('start_audit')
                                <div class="error text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="date" id="end_audit" required="" placeholder="Masukan tanggal selesai audit" name="end_audit" value="{{old('end_audit', $audit->end_audit)}}">
                            @error('end_audit')
                                <div class="error text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            @php
                                $selectedAuditors = old(
                                    'auditors_ids',
                                    $audit->auditors->pluck('id')->toArray()
                                );
                            @endphp
